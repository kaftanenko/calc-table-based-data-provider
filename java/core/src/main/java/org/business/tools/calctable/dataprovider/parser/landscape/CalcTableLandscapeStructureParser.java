...
public class CalcTableLandscapeStructureParser {
	...
	)
	{
		...
		final Cell currentStructureCell = CalcTablePoiNavigationUtils.getCell(
			sheet,
		...
		final boolean stopTraversingStructureCells = StringUtils.isBlank(
